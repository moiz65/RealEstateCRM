...
const routes = [
  // ========================== Dashboard ==========================
  {
    ...
    path: "/default",
    icon: <Icon as={MdHome} width="20px" height="20px" color="#F36922" />,
  ...
  // ------------- lead Routes ------------------------
  {
    ...
    path: "/lead",
    icon: (
      <Icon as={MdLeaderboard} width="20px" height="20px" color="#F36922" />
    ),
    component: Lead,
  },
  {
  ...
  // --------------- contact Routes --------------------
  {
    ...
    layout: [ROLE_PATH.superAdmin, ROLE_PATH.user],
    path: "/contacts",
    icon: <Icon as={MdContacts} width="20px" height="20px" color="#F36922" />,
    component: Contact,
  },
  {
    name: "Contacts",
  ...
  // ------------- Property Routes ------------------------
  {
    ...
    layout: [ROLE_PATH.superAdmin, ROLE_PATH.user],
    path: "/properties",
    icon: <Icon as={LuBuilding2} width="20px" height="20px" color="#F36922" />,
    component: Property,
  },
  {
    name: "Properties",
  ...
  // -----------------------------Opportunities-------------------------------------
  {
    ...
    layout: [ROLE_PATH.superAdmin, ROLE_PATH.user],
    path: "/opportunities",
    icon: <Icon as={TbBulb} width="20px" height="20px" color="#F36922" />,
  ...
  //   icon: (
  //     <Icon as={FaDiagramProject} width="20px" height="20px" color="#F36922" />
  //   ),
  ...
  //   path: "/offerletter",
  //   icon: (
  //     <Icon as={BsBlockquoteRight} width="20px" height="20px" color="#F36922" />
  //   ),
  //   component: Quotes,
  // },
  // {
  ...
  // --------------- Invoices Routes --------------------
  {
    ...
    path: "/invoices",
    icon: (
      <Icon as={TbFileInvoice} width="20px" height="20px" color="#F36922" />
    ),
    component: Invoices,
  },
  {
  ...
  //   icon: <Icon as={GiSatelliteCommunication} width='20px' height='20px' color='#F36922' />,
  ...
  // },
    ...
    //   layout: [ROLE_PATH.superAdmin, ROLE_PATH.user],
    //   path: "/bank-details",
    //   icon: <Icon as={FaPiggyBank} width="20px" height="20px" color="#F36922" />,
  ...
  // ------------- Task Routes ------------------------
  {
    ...
    layout: [ROLE_PATH.superAdmin, ROLE_PATH.user],
    path: "/task",
    icon: <Icon as={FaTasks} width="20px" height="20px" color="#F36922" />,
    component: Task,
  },
  {
    name: "Tasks",
  ...
  // ------------- Meeting Routes ------------------------
  {
    ...
    layout: [ROLE_PATH.superAdmin, ROLE_PATH.user],
    path: "/metting",
    icon: <Icon as={SiGooglemeet} width="20px" height="20px" color="#F36922" />,
    component: Meeting,
  },
  {
    name: "Meetings ",
  ...
  // ------------- Phone Routes ------------------------
  {
    ...
    path: "/phone-call",
    icon: (
      <Icon as={PiPhoneCallBold} width="20px" height="20px" color="#F36922" />
    ),
    component: PhoneCall,
  },
  {
  ...
  // ------------- Email Routes------------------------
  {
    ...
    path: "/email",
    icon: (
      <Icon as={AiOutlineMail} width="20px" height="20px" color="#F36922" />
    ),
  ...
  // -----------------------------Email Template-------------------------------------
  {
    ...
    layout: [ROLE_PATH.superAdmin, ROLE_PATH.user],
    path: "/email-template",
    icon: <Icon as={HiTemplate} width="20px" height="20px" color="#F36922" />,
  ...
  // ------------- Calender Routes ------------------------
  {
    ...
    path: "/calender",
    icon: (
      <Icon as={FaCalendarAlt} width="20px" height="20px" color="#F36922" />
    ),
    component: Calender,
  },
  // ------------- Payments Routes ------------------------
  {
    ...
    layout: [ROLE_PATH.superAdmin, ROLE_PATH.user],
    path: "/payments",
    icon: <Icon as={FaRupeeSign} width="20px" height="20px" color="#F36922" />,
    component: Payments,
  },
  ...
  // ------------- Document Routes ------------------------
  {
    ...
    path: "/documents",
    icon: (
      <Icon as={AiFillFolderOpen} width="20px" height="20px" color="#F36922" />
    ),
    component: Document,
  },
  // ----------------- Reporting Layout -----------------
